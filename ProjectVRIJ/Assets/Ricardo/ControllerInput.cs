...
public class ControllerInput : MonoBehaviour
{
    ...
    //additional note: this is half a decade old code im reusing for testing purposes. If i havent replaced this by the end of the project, you are allowed to slap me.
